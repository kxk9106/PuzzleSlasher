...
extern "C" void ReliabilityContractAttribute__ctor_m6188 (ReliabilityContractAttribute_t1131 * __this, int32_t ___consistencyGuarantee, int32_t ___cer, const MethodInfo* method) IL2CPP_METHOD_ATTR;
