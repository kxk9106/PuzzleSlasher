...
void g_System_Core_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	...
	}
	{
		...
		AssemblyTitleAttribute__ctor_m2598(tmp, il2cpp_codegen_string_new_wrapper("System.Core.dll"), NULL);
	...
	}
	{
		...
		AssemblyDescriptionAttribute__ctor_m2596(tmp, il2cpp_codegen_string_new_wrapper("System.Core.dll"), NULL);
	...
	}
	{
		...
		AssemblyDefaultAliasAttribute__ctor_m2595(tmp, il2cpp_codegen_string_new_wrapper("System.Core.dll"), NULL);
...
void ExtensionAttribute_t398_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(Object_t *) * cache->count, 0);
	{
		...
		AttributeUsageAttribute__ctor_m1416(tmp, 69, NULL);
		cache->attributes[0] = (Il2CppObject*)tmp;
	}
}
extern const CustomAttributesCacheGenerator g_System_Core_Assembly_AttributeGenerators[3] = 
{
	...
	ExtensionAttribute_t398_CustomAttributesCacheGenerator,
};
