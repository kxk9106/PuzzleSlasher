...
struct  X509Store_t568  : public Object_t
{
	...
	X509Certificate2Collection_t559 * ___list_2;
	...
	X509Store_t582 * ___store_4;
};
struct X509Store_t568_StaticFields{
	...
	Dictionary_2_t94 * ___U3CU3Ef__switchU24mapF_5;
};
