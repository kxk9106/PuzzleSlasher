...
struct  X509EnhancedKeyUsageExtension_t574  : public X509Extension_t554
{
	...
	OidCollection_t571 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t574_StaticFields{
	...
	Dictionary_2_t94 * ___U3CU3Ef__switchU24mapE_6;
};
