...
struct  SslStreamBase_t827  : public Stream_t813
{
	// System.IO.Stream Mono.Security.Protocol.Tls.SslStreamBase::innerStream
	Stream_t813 * ___innerStream_3;
