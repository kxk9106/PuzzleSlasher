...
struct  FtpWebRequest_t514  : public WebRequest_t510
{
	...
	RemoteCertificateValidationCallback_t513 * ___callback_15;
};
struct FtpWebRequest_t514_StaticFields{
	...
	RemoteCertificateValidationCallback_t513 * ___U3CU3Ef__amU24cache1C_16;
};
