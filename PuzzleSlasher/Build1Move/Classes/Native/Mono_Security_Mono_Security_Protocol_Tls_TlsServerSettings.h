...
struct  TlsServerSettings_t802  : public Object_t
{
	...
	RSAParameters_t680  ___rsaParameters_2;
	// System.Byte[] Mono.Security.Protocol.Tls.TlsServerSettings::signedParams
	ByteU5BU5D_t110* ___signedParams_3;
	...
	ClientCertificateTypeU5BU5D_t833* ___certificateTypes_7;
};
