...
struct  X509Store_t558  : public Object_t
{
	...
	X509Certificate2Collection_t549 * ___list_2;
	...
	X509Store_t572 * ___store_4;
};
struct X509Store_t558_StaticFields{
	...
	Dictionary_2_t86 * ___U3CU3Ef__switchU24mapF_5;
};
