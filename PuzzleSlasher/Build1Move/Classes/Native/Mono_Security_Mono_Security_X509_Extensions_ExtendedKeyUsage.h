...
struct  ExtendedKeyUsageExtension_t776  : public X509Extension_t664
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t496 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t776_StaticFields{
	...
	Dictionary_2_t86 * ___U3CU3Ef__switchU24map14_4;
};
