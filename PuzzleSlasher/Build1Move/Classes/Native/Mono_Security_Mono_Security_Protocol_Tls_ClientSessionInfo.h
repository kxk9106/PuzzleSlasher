...
struct  ClientSessionInfo_t799  : public Object_t
{
	...
	ByteU5BU5D_t110* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t110* ___masterSecret_5;
};
struct ClientSessionInfo_t799_StaticFields{
