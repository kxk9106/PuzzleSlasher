...
struct  X509EnhancedKeyUsageExtension_t564  : public X509Extension_t544
{
	...
	OidCollection_t561 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t564_StaticFields{
	...
	Dictionary_2_t86 * ___U3CU3Ef__switchU24mapE_6;
};
