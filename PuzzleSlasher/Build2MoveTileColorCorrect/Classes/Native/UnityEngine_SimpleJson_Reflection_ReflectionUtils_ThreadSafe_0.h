...
struct  ThreadSafeDictionary_2_t369  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t368 * ____valueFactory_1;
	...
	Dictionary_2_t2124 * ____dictionary_2;
};
