...
struct  ExtendedKeyUsageExtension_t786  : public X509Extension_t674
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t506 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t786_StaticFields{
	...
	Dictionary_2_t93 * ___U3CU3Ef__switchU24map14_4;
};
