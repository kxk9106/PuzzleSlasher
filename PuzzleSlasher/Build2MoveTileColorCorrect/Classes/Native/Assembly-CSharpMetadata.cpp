...
static const char* s_StringTable[6] = 
{
	"tilePrefab",
	"ball",
	"tiles",
...
#endif
static const Il2CppFieldDefinition s_FieldTable[6] = 
{
	{ 0, 11, offsetof(Ground_t3, ___tilePrefab_2), 0 } ,
	{ 1, 11, offsetof(Ground_t3, ___ball_3), 0 } ,
	{ 2, 12, offsetof(Ground_t3, ___tiles_4), 0 } ,
	{ 3, 17, offsetof(Move_t6, ___dir_2), 0 } ,
	{ 4, 18, offsetof(Move_t6, ___speed_3), 0 } ,
	{ 5, 19, offsetof(Move_t6, ___rb_4), 0 } ,
};
#ifdef __clang__
