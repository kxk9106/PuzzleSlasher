...
struct  ClientSessionInfo_t809  : public Object_t
{
	...
	ByteU5BU5D_t117* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t117* ___masterSecret_5;
};
struct ClientSessionInfo_t809_StaticFields{
